...
#define LOGIN_URL "http://www.baidu.com" //登录url
...
#define FORGET_PASSWORD_URL  "https://aq.qq.com/v2/uv_aq/html/reset_pwd/pc_reset_pwd_input_account.html?v=3.0" //定义忘记密码

#define TEST_GET_URL "http://127.0.0.1:8000/users/"   //测试getdata功能
